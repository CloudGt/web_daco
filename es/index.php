...
<body>
					...
					<div class="navbar navbar-fixed-top">
			    		<div class="navbar-inner">
			          		...
			          		<div class="nav-collapse collapse">
			          			<a href="#" class="navbar-left"><img src="img/daco1.png"></a>
			            		<ul class="nav">

									<li><a href="#" class="home">Inicio</a></li>
			              			<li><a href="#" class="Servicios_daco">Servicios</a></li>
									<!-- <li><a href="#" class="portfolio">Clientes</a></li> -->
	...
	<!--end: Header-->
	<!--start: llamada a dacotrans-->
	<div class="row">
	  <div class="hidden-desktop">
	  		<a href="tel:+50223811200" class="btn btn-block btn-lg btn-success">
				...
				<div class="row">
					<div class="col-md-12 ">
						<div class="responsive-video">
							<iframe width="320" height="180" src="https://www.youtube.com/embed/83OTW_Nfru4" frameborder="0" allowfullscreen>
							</iframe>
						</div>
					</div>
				</div>	
	...
	<!-- end: 2nd Page - Pricing Tables -->

	<!-- start: 3rd Page - Services -->
	<div id="Servicios_daco" class="color black">
	    	...
	    	<div class="row-fluid">
				...
				<div class="span12">
					...
					<div id="history" align="justify">
						...
						<h3>Valores</h3>
						<p>
							<span class="dropcap">V</span>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.
						</p>
...
<!-- end: Row -->
	...
	<footer>
		...
		<div id="copyright">
			 <a href="http://bootstrapmaster.com" alt="Bootstrap Themes"></a> <img src="img/poland.png" alt="Poland" style="margin-top:-4px">
		</div>
		<div id="social">
			<a href="http://facebook.com/" rel="tooltip" title="Facebook" class="facebook">Facebook</a>
			<a href="http://facebook.com/" rel="tooltip" title="Twitter" class="twitter">Twitter</a>
